    ...
    <section id="prove-product-cat-config">
        <div class="container">
          <div class="page-header">
            <h1>Bienvenido al Panel de Administración de <small class="tittles-pages-logo" style="color: #B4006E">SHEINDEL GARCÍA Boutique</small></h1>
          </div>
          <!--====  Nav Tabs  ====-->
          ...
          <?php
            ...
            if(isset($content)){
              ...
              echo '<h2 class="text-center">Para comenzar, por favor escoja una opción del menú de administración. ♥</h2>';
            }
          ?>
        </div>
    </section>
