    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO <small class="tittles-pages-logo">SHEINDEL GARCÍA Boutique</small></h1>
            </div>
                ...
                <div class="col-sm-7">
                    <div id="container-form">
                       ...
                       <form class="FormCatElec" action="process/regclien.php" role="form" method="POST" data-form="save">
                            ...
                            <div class="row">
                              ...
                              <div class="col-xs-12">
                                <div class="form-group label-floating">
                                  ...
                                  <input class="form-control" type="text" required name="clien-nit"  title="Ingrese su número de DNI. Solamente números" maxlength="18" >
                                </div>
                              <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                  <label class="control-label"><i class="fa fa-user"></i>&nbsp; Nombre(s)</label>
                              ...
                              <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                  <label class="control-label"><i class="fa fa-mobile"></i>&nbsp; Celular</label>
                          ...
                          <p><button type="submit" class="btn btn-primary btn-block btn-raised" style="background-color:#FF8BD2; border-color:blue; color:white">Registrarse</button></p>
                        </form> 
                    </div> 
                </div>
            </div>
