       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>PRODUCTOS <small class="tittles-pages-logo">SHEINDEL GARCÍA Boutique</small></h1>
            </div>
            <?php
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-xs-12 col-md-4">
                    <div class="dropdown">
                      <button class="btn btn-primary btn-raised dropdown-toggle" type="button" id="drpdowncategory" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" style="background-color:#D8178D; border-color:blue; color:white">
                      ...
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <span class="input-group-btn">
                              <button class="btn btn-info btn-raised" type="submit" style="background-color:#FF8BD2; border-color:blue; color:white">Buscar</button>
                          </span>
                        </div>
                      </div>
                    </form>
