<p class="lead">
    En esta sección podrás vizualizar todos los pedidos realizados por los clientes.
</p>
<div class="container">
  <div class="row" >
        <div class="col-xs-12">
            ...
            <div class="panel panel-info">
                <div class="panel-heading text-center"><h4>Pedidos de SHEINDEL</h4></div>
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        <thead class="">
                            <tr>
                              <th class="text-center">#</th>
                                <th class="text-center">N. Depósito</th>
