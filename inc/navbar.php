...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs">
            <div class="col-xs-4">
                <img src="assets/img/logo.jpg" class="img-responsive" style="float: left; margin-right: 15px; width: 65px; display: block;">
                <p class="text-navbar tittles-pages-logo">SHEINDEL GARCÍA Boutique</p>
            </div>
            <div class="col-xs-8">
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">SHEINDEL GARCÍA Boutique</h3>
