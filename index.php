        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                ...
                <div class="carousel-caption">
                    SHEINDEL GARCÍA Boutique, ¡a tus órdenes!
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/slider2.png" alt="slider2">
                <div class="carousel-caption">
                    Increíbles Descuentos en Nuestra Boutique
                </div>
            </div>
            <div class="item">
                <img src="./assets/img/slider3.png" alt="slider3">
                <div class="carousel-caption">
                    Moda de Primavera Verano, ¡Inicia ahora!
                </div>
            </div>
        </div>
    ...
    <section id="new-prod-index">    
         <div class="container">
            <div class="page-header">
                <h1>Nuevos <small>productos de la Tienda</small></h1>
            </div>
            <div class="row">
              	<?php
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:5%;">
                        ...
                        <h3>¡Regístrate!</h3>
                        <p>Regístrate como cliente de <span class="tittles-pages-logo">SHEINDEL GARCÍA Boutique</span> en un sencillo formulario para poder completar tus pedidos.</p>
                        <p><a href="registration.php" class="btn btn-info btn-raised btn-block">Registrarse</a></p>   
                   </article>
                </div>

                <div class="col-xs-12 col-sm-6">
                    <img src="assets/img/bolsitas.png" alt="bolsa" class="img-responsive" style="width: 70%; display: block; margin: 0 auto;">
                </div>
            </div>
        </div>
    </section>
